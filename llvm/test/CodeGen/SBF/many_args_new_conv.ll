...
; Loading arguments
; CHECK: ldxdw r2, [r10 + 2104]
; CHECK: ldxdw r2, [r10 + 2096]
; CHECK: ldxdw r2, [r10 + 2088]
; CHECK: ldxdw r2, [r10 + 2080]
; CHECK: ldxdw r2, [r10 + 2072]
; Loading allocated i32
; CHECK: ldxw r0, [r10 + 24]

; CHECK-V3: ldxdw r2, [r10 - 4096]
; CHECK-V3: ldxdw r2, [r10 - 4088]
; CHECK-V3: ldxdw r2, [r10 - 4080]
; CHECK-V3: ldxdw r2, [r10 - 4072]
; CHECK-V3: ldxdw r2, [r10 - 4064]
; Loading allocated i32
...
; Loading arguments
; CHECK-V3: ldxdw r1, [r10 - 4096]
; CHECK-V3: ldxdw r1, [r10 - 4088]
; CHECK-V3: ldxdw r1, [r10 - 4080]
; CHECK-V3: ldxdw r1, [r10 - 4072]
; CHECK-V3: ldxdw r1, [r10 - 4064]
